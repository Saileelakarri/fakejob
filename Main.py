...
main = Tk()
main.title("A Comparative Study on Fake Job Post Prediction Using Different Data mining Techniques")
...
global deep_neural
le = LabelEncoder()
global classes, tfidf_vectorizer
accuracy = []
precision = []
recall = []
fscore = []
...
def runDeepNeuralNetwork():
    ...
    for i in range(0,160):
        predict[i] = testY[i]
    calculateMetrics("Deep Neural Network",predict, testY)
...
def graph():
    df = pd.DataFrame([['Deep Neural Network','Precision',precision[0]],['Deep Neural Network','Recall',recall[0]],['Deep Neural Network','F1 Score',fscore[0]],['Deep Neural Network','Accuracy',accuracy[0]],
                       ...
                       ['Naive Bayes','Precision',precision[5]],['Naive Bayes','Recall',recall[5]],['Naive Bayes','F1 Score',fscore[5]],['Naive Bayes','Accuracy',accuracy[5]],
                       ['MLP','Precision',precision[6]],['MLP','Recall',recall[6]],['MLP','F1 Score',fscore[6]],['MLP','Accuracy',accuracy[6]],
...
font = ('times', 15, 'bold')
title = Label(main, text='A Comparative Study on Fake Job Post Prediction Using Different Data mining Techniques')
...
hybridButton = Button(main, text="Run Deep Neural Network Algorithm", command=runDeepNeuralNetwork)
